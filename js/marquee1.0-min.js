...
this.doSize();if(this.pannel.find("img").length){this.pannel.find("img").each(function(){var b=this;if(b.complete){a.doSize();}else{b.onload=function(){a.doSize();
};b.onerror=function(){a.doSize();};}});}if(this.config.overStop){this.obj.hover(function(){a.doStop();},function(){a.doPlay();});}},doSize:function(){var a=0;
